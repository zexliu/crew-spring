...
@ServerEndpoint("/ws/v1/attendance/{clientId}")
@Component
@Slf4j
public class WebSocketServer {
     ...
     * 发送自定义消息
     */
    public static void sendMessage(String message,  String clientId) throws IOException {
        log.info("发送消息到:" + clientId + "，报文:" + message);
        if (StringUtils.isNotBlank(clientId) && onlineSessions.containsKey(clientId)) {
